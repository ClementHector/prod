...
def studio_config_file(config_context):
    ...
    studio_config_path = os.path.join(config_context['temp_dir'].name, 'studio_software.ini')
...
def production_config_file(config_context):
    ...
    prod_config_path = os.path.join(config_context['temp_dir'].name, 'prod_software.ini')
...
def check_override_values(config_context):
    ...
    houdini_version = config_context['config_manager'].get_merged_config('houdini', 'version')
...
def check_maya_packages(config_context):
    ...
    maya_packages = config_context['config_manager'].get_merged_config('maya', 'packages')
...
def check_nuke_packages(config_context):
    ...
    nuke_packages = config_context['config_manager'].get_merged_config('nuke', 'packages')
...
def apply_override(config_context):
    ...
    config_context['config_manager'].apply_temporary_override('maya', 'version', '2023.4.0')
