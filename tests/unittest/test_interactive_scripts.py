...
def test_generate_interactive_shell_script_with_software_list_windows(mock_platform):
    """
    Test the generation of an interactive script with a directly provided software list on Windows.
    """
...
def test_generate_interactive_shell_script_with_software_list_linux(mock_platform):
    """
    Test the generation of an interactive script with a directly provided software list on Linux.
    """
    # Create the environment manager
    env_manager = EnvironmentManager()
