...
class ConfigManager:
    ...
    def load_override_config(self, config_path: str) -> None:
        ...
        if os.path.exists(config_path):
            ...
            raise FileNotFoundError(f"Override configuration file not found: {config_path}")
    
    def get_merged_config(self, section: str, key: str, default: Optional[str] = None) -> str:
        """
    ...
    def has_section(self, section: str) -> bool:
        ...
        """
        return (self.config_parser.has_section(section) or 
                self.override_config.has_section(section))
